...
- (void)testInsertion2 {
	...
	XCTAssertTrue([self.query.objects containsObject:event1], @"Store should contain event1.");
	XCTAssertTrue([self.query.objects containsObject:event2], @"Store should contain event2.");
}
...
- (void)testDeletion {
	...
	XCTAssertEqual(self.query.objects.count, (NSUInteger)0, @"Should contain no objects.");
}
...
- (void)testDeletion2 {
	...
	XCTAssertEqual(self.query.objects.count, (NSUInteger)1, @"The store should contain one object.");
	XCTAssertEqualObjects([self.query.objects firstObject], event2, @"The object should be event2.");
}
